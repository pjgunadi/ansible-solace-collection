...
DOCUMENTATION = '''
---
module: solace_get_vpn_proxies
short_description: get list of proxies on a message vpn
description:
- "Get a list of Proxy objects configured on a Message Vpn."
notes:
...
seealso:
- module: solace.pubsub_plus.solace_vpn_proxy
author:
...
class SolaceGetVpnProxiesTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/proxies
        return ['msgVpns', params['msg_vpn'], 'proxies']
...
def run_module():
    ...
    solace_task = SolaceGetVpnProxiesTask(module)
    solace_task.execute()
