...
DOCUMENTATION = '''
---
module: solace_get_kafka_senders
short_description: get list of kafka senders on a message vpn
description:
- "Get a list of Kafka Sender objects configured on a Message Vpn."
notes:
...
class SolaceGetKafkaSendersTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/kafkaSenders
...
def run_module():
    ...
    solace_task = SolaceGetKafkaSendersTask(module)
    solace_task.execute()
