...
DOCUMENTATION = '''
---
module: solace_get_kafka_receivers
short_description: get list of kafka receivers on a message vpn
description:
- "Get a list of Kafka Receiver objects configured on a Message Vpn."
notes:
...
class SolaceGetKafkaReceiversTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/kafkaReceivers
...
def run_module():
    ...
    solace_task = SolaceGetKafkaReceiversTask(module)
    solace_task.execute()
