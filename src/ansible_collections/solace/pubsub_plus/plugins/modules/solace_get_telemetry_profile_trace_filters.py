...
DOCUMENTATION = '''
---
module: solace_get_telemetry_profile_trace_filters
short_description: get list of trace filters on a telemetry profile
description:
- "Get a list of Trace Filter objects configured on a Telemetry Profile object."
notes:
...
class SolaceGetTelemetryProfileTraceFiltersTask(SolaceBrokerGetPagingTask):
    ...
    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/telemetryProfiles/{telemetryProfileName}/traceFilters
        return ['msgVpns', params['msg_vpn'], 'telemetryProfiles',
                params['telemetry_profile_name'], 'traceFilters']
...
def run_module():
    ...
    solace_task = SolaceGetTelemetryProfileTraceFiltersTask(module)
    solace_task.execute()
