...
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/authenticationOauthProvider/\
  getMsgVpnAuthenticationOauthProviders"
...
seealso:
- module: solace.pubsub_plus.solace_authentication_oauth_provider
author:
