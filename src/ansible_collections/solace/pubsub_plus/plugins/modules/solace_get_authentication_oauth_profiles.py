...
DOCUMENTATION = '''
---
module: solace_get_authentication_oauth_profiles
short_description: get list of oauth profiles
description:
- "Get a list of Authentication OAuth Profile objects configured on a Message Vpn."
notes:
...
- solace.pubsub_plus
module_defaults:
  solace_get_authentication_oauth_profiles:
    host: "{{ sempv2_host }}"
    port: "{{ sempv2_port }}"
...
class SolaceGetAuthenticationOAuthProfilesTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/authenticationOauthProfiles
...
def run_module():
    ...
    solace_task = SolaceGetAuthenticationOAuthProfilesTask(module)
    solace_task.execute()
