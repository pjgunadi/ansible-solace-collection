...
DOCUMENTATION = '''
---
module: solace_get_topic_endpoint_templates
short_description: get list of topic endpoint templates on a message vpn
description:
- "Get a list of Topic Endpoint Template objects configured on a Message Vpn."
notes:
...
seealso:
- module: solace.pubsub_plus.solace_topic_endpoint_template
author:
...
- solace.pubsub_plus
module_defaults:
  solace_get_topic_endpoint_templates:
    host: "{{ sempv2_host }}"
    port: "{{ sempv2_port }}"
...
class SolaceGetTopicEndpointTemplatesTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/topicEndpointTemplates
        return ['msgVpns', params['msg_vpn'], 'topicEndpointTemplates']
...
def run_module():
    ...
    solace_task = SolaceGetTopicEndpointTemplatesTask(module)
    solace_task.execute()
