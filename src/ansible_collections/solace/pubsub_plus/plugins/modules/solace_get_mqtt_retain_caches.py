...
DOCUMENTATION = '''
---
module: solace_get_mqtt_retain_caches
short_description: get list of mqtt retain caches on a message vpn
description:
- "Get a list of MQTT Retain Cache objects configured on a Message Vpn."
notes:
...
seealso:
- module: solace.pubsub_plus.solace_mqtt_retain_cache
author:
...
class SolaceGetMqttRetainCachesTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/mqttRetainCaches
        return ['msgVpns', params['msg_vpn'], 'mqttRetainCaches']
...
def run_module():
    ...
    solace_task = SolaceGetMqttRetainCachesTask(module)
    solace_task.execute()
