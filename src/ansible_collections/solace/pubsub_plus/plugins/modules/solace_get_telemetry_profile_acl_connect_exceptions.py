...
DOCUMENTATION = '''
---
module: solace_get_telemetry_profile_acl_connect_exceptions
short_description: get list of acl connect exceptions on a telemetry profile
description:
- "Get a list of ACL Connect Exception objects configured on a Telemetry Profile object."
notes:
- "Module Sempv2 Config: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/config/index.html#/msgVpn/\
  getMsgVpnTelemetryProfileAclConnectExceptions"
...
class SolaceGetTelemetryProfileAclConnectExceptionsTask(SolaceBrokerGetPagingTask):
...
def run_module():
    ...
    solace_task = SolaceGetTelemetryProfileAclConnectExceptionsTask(module)
    solace_task.execute()
