...
DOCUMENTATION = '''
---
module: solace_get_telemetry_profiles
short_description: get list of telemetry profiles on a message vpn
description:
- "Get a list of Telemetry Profile objects configured on a Message Vpn."
notes:
...
class SolaceGetTelemetryProfilesTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/telemetryProfiles
...
def run_module():
    ...
    solace_task = SolaceGetTelemetryProfilesTask(module)
    solace_task.execute()
