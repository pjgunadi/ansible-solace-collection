...
DOCUMENTATION = '''
---
module: solace_get_proxies
short_description: get list of proxies
description:
- "Get a list of Proxy objects configured on the broker."
notes:
- "Module Sempv2 Config: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/config/index.html#/proxy/\
  getProxies"
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/proxy/\
  getProxies"
options: {}
...
class SolaceGetProxiesTask(SolaceBrokerGetPagingTask):
...
def run_module():
    ...
    solace_task = SolaceGetProxiesTask(module)
    solace_task.execute()
