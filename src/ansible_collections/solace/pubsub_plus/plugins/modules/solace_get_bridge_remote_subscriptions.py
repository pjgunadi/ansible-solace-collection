...
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/bridge/\
...
seealso:
- module: solace.pubsub_plus.solace_bridge
- module: solace.pubsub_plus.solace_bridge_remote_subscription
- module: solace.pubsub_plus.solace_bridge_remote_subscriptions
author:
