...
- "Allows addition and removal of a list of Subscribe Topic Exception objects as well as replacement of all existing Subscribe Topic Exception objects on an
  ACL Profile."
