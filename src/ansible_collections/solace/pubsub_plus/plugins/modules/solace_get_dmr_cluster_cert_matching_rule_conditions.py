...
DOCUMENTATION = '''
---
module: solace_get_dmr_cluster_cert_matching_rule_conditions
short_description: get list of conditions on a dmr cluster certificate matching rule
description:
- "Get a list of Condition objects configured on a DMR Cluster Certificate Matching Rule object."
notes:
...
- solace.pubsub_plus
module_defaults:
  solace_get_dmr_cluster_cert_matching_rule_conditions:
    host: "{{ sempv2_host }}"
    port: "{{ sempv2_port }}"
...
class SolaceGetDmrClusterCertMatchingRuleConditionsTask(SolaceBrokerGetPagingTask):
    ...
    def get_path_array(self, params: dict) -> list:
        # GET /dmrClusters/{dmrClusterName}/certMatchingRules/{certMatchingRuleName}/conditions
...
def run_module():
    ...
    solace_task = SolaceGetDmrClusterCertMatchingRuleConditionsTask(module)
    solace_task.execute()
