...
- "Allows addition and removal of a list of Publish Topic Exception objects as well as replacement of all existing Publish Topic Exception objects on an ACL
  Profile."
