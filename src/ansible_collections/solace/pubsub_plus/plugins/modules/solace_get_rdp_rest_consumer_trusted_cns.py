...
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/restDeliveryPoint/\
  getMsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNames"
options:
  rdp_name:
...
seealso:
- module: solace.pubsub_plus.solace_rdp_rest_consumer_trusted_cn
author:
