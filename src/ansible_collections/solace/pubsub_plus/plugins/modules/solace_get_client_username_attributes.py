...
DOCUMENTATION = '''
---
module: solace_get_client_username_attributes
short_description: get list of attributes on a client username
description:
- "Get a list of Attribute objects configured on a Client Username object."
notes:
...
seealso:
- module: solace.pubsub_plus.solace_client_username_attribute
author:
...
- solace.pubsub_plus
module_defaults:
  solace_get_client_username_attributes:
    host: "{{ sempv2_host }}"
    port: "{{ sempv2_port }}"
...
class SolaceGetClientUsernameAttributesTask(SolaceBrokerGetPagingTask):
    ...
    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/clientUsernames/{clientUsername}/attributes
        return ['msgVpns', params['msg_vpn'], 'clientUsernames', params['client_username'], 'attributes']
...
def run_module():
    ...
    solace_task = SolaceGetClientUsernameAttributesTask(module)
    solace_task.execute()
