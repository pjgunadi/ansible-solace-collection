...
DOCUMENTATION = '''
---
module: solace_get_cert_matching_rule_attribute_filters
short_description: get list of attribute filters on a message vpn certificate matching rule
description:
- "Get a list of Attribute Filter objects configured on a Message Vpn Certificate Matching Rule object."
notes:
...
- solace.pubsub_plus
module_defaults:
  solace_get_cert_matching_rule_attribute_filters:
    host: "{{ sempv2_host }}"
    port: "{{ sempv2_port }}"
...
class SolaceGetCertMatchingRuleAttributeFiltersTask(SolaceBrokerGetPagingTask):
    ...
    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/certMatchingRules/{certMatchingRuleName}/attributeFilters
...
def run_module():
    ...
    solace_task = SolaceGetCertMatchingRuleAttributeFiltersTask(module)
    solace_task.execute()
