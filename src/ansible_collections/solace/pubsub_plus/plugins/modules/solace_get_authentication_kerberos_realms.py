...
DOCUMENTATION = '''
---
module: solace_get_authentication_kerberos_realms
short_description: get list of kerberos realms
description:
- "Get a list of Authentication Kerberos Realm objects configured on a Message Vpn."
notes:
...
seealso:
- module: solace.pubsub_plus.solace_authentication_kerberos_realm
author:
...
- solace.pubsub_plus
module_defaults:
  solace_get_authentication_kerberos_realms:
    host: "{{ sempv2_host }}"
    port: "{{ sempv2_port }}"
...
class SolaceGetAuthenticationKerberosRealmsTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/authenticationKerberosRealms
        return ['msgVpns', params['msg_vpn'], 'authenticationKerberosRealms']
...
def run_module():
    ...
    solace_task = SolaceGetAuthenticationKerberosRealmsTask(module)
    solace_task.execute()
