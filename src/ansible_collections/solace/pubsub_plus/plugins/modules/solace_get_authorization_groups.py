...
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/authorizationGroup/\
  getMsgVpnAuthorizationGroups"
...
seealso:
- module: solace.pubsub_plus.solace_authorization_group
author:
