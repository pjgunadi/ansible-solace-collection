...
DOCUMENTATION = '''
---
module: solace_get_cert_matching_rules
short_description: get list of certificate matching rules on a message vpn
description:
- "Get a list of Certificate Matching Rule objects configured on a Message Vpn."
notes:
...
- solace.pubsub_plus
module_defaults:
  solace_get_cert_matching_rules:
    host: "{{ sempv2_host }}"
    port: "{{ sempv2_port }}"
...
class SolaceGetCertMatchingRulesTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/certMatchingRules
...
def run_module():
    ...
    solace_task = SolaceGetCertMatchingRulesTask(module)
    solace_task.execute()
